...
//
//	mockgen -source=router.go -destination=router_mock_test.go -package=router -write_package_comment=false
package router
...
func (mr *MockRegistryRepositoryMockRecorder) DeleteKey(k, path any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockGameFinderMockRecorder) GetInstallDir(config any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockGameFinderMockRecorder) GetInstallDirFromSomewhere(configs any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockGameFinderMockRecorder) IsInstalled(config any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockGameFinderMockRecorder) IsInstalledAnywhere(configs any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockGameLauncher) StartGame(u *url.URL, config game_launcher.Config, launchType game_launcher.LaunchType, cmdBuilder game_launcher.CommandBuilder, hookHandlers ...game_launcher.HookHandler) error {
	m.ctrl.T.Helper()
	varargs := []any{u, config, launchType, cmdBuilder}
...
func (mr *MockGameLauncherMockRecorder) StartGame(u, config, launchType, cmdBuilder any, hookHandlers ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{u, config, launchType, cmdBuilder}, hookHandlers...)
